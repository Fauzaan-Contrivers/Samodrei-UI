...
import PrescriberViewLeft from "src/views/prescribers/PrescriberViewLeft";
import PrescriberViewRight from "src/views/prescribers/PrescriberViewRight";
      ...
      <>
        <Grid container spacing={6}>
          <Grid item xs={12} md={5} lg={4}>
            <PrescriberViewLeft data={data?.result[0]} />
          </Grid>
          <Grid item xs={12} md={7} lg={8}>
            <PrescriberViewRight prescriber={data?.result[0]} />
          </Grid>
        </Grid>
      </>
    );
