...
const Preview = ({ id, invoiceData }) => {
  ...
  if (data) {
    return (
      <Card>
        <CardHeader title={'Job Details'} titleTypographyProps={{ variant: 'h6' }} />
        <CardContent>
          <Grid container>
        ...
        {data.Status == 'Feedback completed' && (
          <>
            ...
            <CardHeader title={'Feedback Details'} titleTypographyProps={{ variant: 'h6' }} />
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <MUITableCell>
                            {data?.question_7 ? (
                              <Typography sx={{ maxWidth: '50%', fontWeight: 600 }} variant='body2'>
                                {data?.question_7A}
                              </Typography>
                            ) : (
                              <Close sx={{ fontSize: '1rem' }} />
                        ...
                        <TableRow>
                          ...
                          <MUITableCell>
                            {data?.question_13 ? (
                              <>
                                <Typography sx={{ maxWidth: '80%' }} variant='body2'>
                                  {convertDateToReadableFormat(data?.question_13A)}
                                </Typography>
                              </>
                            ) : (
                              <Close sx={{ fontSize: '1rem' }} />
                    ...
                    <Table>
                      <TableBody>
                        <TableRow>
                          <MUITableCell>
                            <Typography sx={{ maxWidth: '80%' }} variant='body2'>
                              Did you discuss how generic loop diuretics worsen bladder problems, especially in elderly
                              patients?
                            </Typography>
                          </MUITableCell>
                          <MUITableCell>
                        ...
                        <TableRow>
                          <MUITableCell>
                            <Typography sx={{ maxWidth: '80%' }} variant='body2'>
                              Did you mention that many patients skip their diuretic dose because of worsening bladder
                              problems?
                            </Typography>
                          </MUITableCell>
                          <MUITableCell>
                        ...
                        <TableRow>
                          <MUITableCell>
                            <Typography sx={{ maxWidth: '80%' }} variant='body2'>
                              Did you request the physician or the person who you met to write “Dispense as Written” or
                              “DAW” to avoid conversion to generic torsemide?
                            </Typography>
                          </MUITableCell>
                          <MUITableCell>
                            {data?.question_6 ? (
                        ...
                        <TableRow>
                          <MUITableCell>
                            <Typography sx={{ maxWidth: '80%' }} variant='body2'>
                              Did you inform the prescriber that SOAANZ can be purchased at a low fixed price from our
                              mail order pharmacy?
                            </Typography>
                          </MUITableCell>
                          <MUITableCell>
                        ...
                        <TableRow>
                          ...
                          <MUITableCell>
                            <Typography variant='body2'>{data?.question_14}</Typography>
                          </MUITableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
        ...
        {data.question_1 && (
          <>
            ...
            <CardHeader title={'Lunch Details'} titleTypographyProps={{ variant: 'h6' }} />
