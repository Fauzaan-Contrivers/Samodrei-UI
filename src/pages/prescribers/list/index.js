...
const InvoiceList = () => {
  ...
  const handleStateChangeHandler = e => {
    dispatch(onPrescriberFilterChangeHandler({ filter: 'State', value: e.target.value }))
  }

  const handleSoaanzStateChangeHandler = e => {
    dispatch(onPrescriberFilterChangeHandler({ filter: 'is_soaanz_prescriber', value: e.target.value }))
  }
  ...
  const defaultColumns = [
    ...
    },
    {
      ...
      headerName: 'Address',
      renderCell: ({ row }) => <Typography variant='body2'>{row?.Street_Address || ''}</Typography>
    },
    {
      flex: 0.2,
      minWidth: 150,
      ...
      renderCell: ({ row }) => <Typography variant='body2'>{row?.Speciality || ''}</Typography>
    },
    {
      flex: 0.2,
      minWidth: 150,
    ...
    },
    {
      ...
      renderCell: ({ row }) => (
        <Typography variant='body2'>
          {' '}
          <Checkbox checked={row?.is_soaanz_prescriber ? true : false} disabled />
        </Typography>
      )
    },
    {
