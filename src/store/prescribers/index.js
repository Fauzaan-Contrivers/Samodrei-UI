...
export const fetchPrescribersData = createAsyncThunk('prescribers/fetchData/', async params => {
  ...
  console.log('total Prescribers records lenght', response.data.result.records.count)
  return {
...
export const fetchPrescriberData = createAsyncThunk('prescriber/fetchData/', async params => {
  let response = await apiCall('POST', 'prescriber/fetch_prescriber_details', {
    ...params,
    id: params.id
  })
...
export const updatePrescriberAddress = createAsyncThunk('prescriber/update_prescriber', async params => {
  let response = await apiCall('POST', 'prescriber/update_prescriber', params)
