        ...
        <CardContent>
          ...
          >
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#ffe700" }}
              />
              <Typography>Front Desk</Typography>
            </Box>
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#FFA1A1" }}
              />
              <Typography>Madical Assistant</Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#826bf8" }}
              />
              <Typography>Nurse Practitioner (NP)</Typography>
            </Box>
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#600bf8" }}
              />
              <Typography>Physician</Typography>
            </Box>
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#800bf8" }}
              />
              <Typography>Office Manager</Typography>
            </Box>
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#899bf8" }}
              />
              <Typography>Physician’s Assistant</Typography>
            </Box>
            <Box sx={{ marginRight: 6, display: "flex", alignItems: "center" }}>
              <Circle
                sx={{ marginRight: 1.5, fontSize: "0.75rem", color: "#342234" }}
              />
